...
public class PendingPostListAdapter extends RecyclerView.Adapter<PendingPostListAdapter.ViewHolder> {
    ...
    @Override
    public PendingPostListAdapter.ViewHolder onCreateViewHolder( ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(PendingPostListAdapter.ViewHolder viewHolder, int i) {
